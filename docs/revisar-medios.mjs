...
const PAGINAS = (process.argv[3] || "index.html,servicios.html,como-trabajamos.html,producto/taller.html,producto/control-de-autos.html,aviso-de-privacidad.html,terminos.html").split(",");
